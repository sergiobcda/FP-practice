...
bool showRules() {
	...
	if (!Rules.is_open()) {
		...
		do {
			getline(Rules, linea);//saca la linea y la pasa por pantalla hasta XXX
			cout << linea;
		} while (linea != "XXX");//el do while es temporal ya que solo pasa la condicion en la 2ª iteracion
